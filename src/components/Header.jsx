...
const Header = () => {
  return (
    <div className='w-11/12 max-w-3xl text-center mx-auto h-screen flex flex-col items-center justify-center gap-4'>
        ...
        <div className='flex flex-col sm: flex-rowitems-center gap-4 mt-4'>
          <Link href="/contact" className='px-10 py-3 border border-white rounded-full bg-black text-white flex items-center gap-2'>Contact Me <img src="" alt="" className='w-4'/></Link>
          <Link href="" className='px-10 py-3 border rounded-full border-gray-500 flex items-center gap-2'>My Resume <img src="" alt="" className='w-4'/></Link>
        </div>
    </div>
  )
}
